...
btn_load = tk.Button(root, text="Download Data", command=load_data)
btn_load.grid(row=3, column=1, padx=5)
btn_load_2 = tk.Button(root, text="Save Data to DB", command=load_data_2)
btn_load_2.grid(row=3, column=2, padx=5)

btn_refresh_diagram = tk.Button(root, text="show diagram", command=refresh_diagram)
